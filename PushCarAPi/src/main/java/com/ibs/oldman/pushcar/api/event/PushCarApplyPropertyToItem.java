...
public class PushCarApplyPropertyToItem extends Event {
     ...
     * @param properties
     */
    public PushCarApplyPropertyToItem(Game game, Player player, ItemStack stack, Map<String, Object> properties) {
        this.game = game;
        this.player = player;
        this.stack = stack;
    ...
    public HandlerList getHandlers() {
        return PushCarApplyPropertyToItem.handlers;
    }
