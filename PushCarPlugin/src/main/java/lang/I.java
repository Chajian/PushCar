...
public class I {
	...
	protected static ITranslateContainer customContainer;//自定义翻译容器
	protected static ITranslateContainer mainContainer;//主翻译容易
	protected static ITranslateContainer fallbackContainer;//后备容器
