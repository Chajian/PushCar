...
public enum TeamColor {
    ...
    TeamColor(org.bukkit.ChatColor chatColor, int woolData, String material1_13, Color leatherColor) {
    ...
    public com.ibs.oldman.pushcar.api.game.TeamColor toApiColor() {
        return com.ibs.oldman.pushcar.api.game.TeamColor.valueOf(this.name());
    }

    public static TeamColor fromApiColor(com.ibs.oldman.pushcar.api.game.TeamColor color) {
